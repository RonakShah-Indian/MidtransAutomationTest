...
public class SuccessfulPaymentTest extends TestBase {
	...
	public void verifyHomePageTitleTest() throws Exception {
		...
		sendText(signUpScreen.creditCardNumberTxtField,"4811111111111114");
		...
		if(isFound(signUpScreen.payNowBtn)){
			signUpScreen.payNowBtn.click();
		}
		...
		Thread.sleep(3000);
		Assert.assertTrue(isFound(signUpScreen.buyNowBtn));
		Reporter.log("This script verifies success payment test");
	}
